...
# test_voice_qa_tools.py van ignore: co 1 FN THAT (R190 prosody khong bat
# synthetic 220->110Hz drop, deep-audit F8) — cho calibration, chua wire.
...
collect_ignore_glob = [
    ...
    'test_harness.py', 'test_voice_qa_tools.py',
]

...
# SU CO 2/7 (origin bi wipe 1037 file): khi pytest chay BEN TRONG git hook
# (pre-commit/pre-push -> ci_gate -> pytest), git export GIT_DIR / GIT_INDEX_FILE /
# GIT_WORK_TREE tro ve REPO THAT -> moi 'git add -A / commit' cua fixture danh vao
# repo that BAT CHAP cwd=tmp_path ('baseline candidate' = commit wipe). Scrub het
# env GIT_* truoc moi subprocess de fixture chi song trong repo tam.

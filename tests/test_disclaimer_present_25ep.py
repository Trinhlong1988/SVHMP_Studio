...
#
# ep_02..ep_10 (9 tap medium): ban dau fail gate R40 intro (variant CU truoc R108/R40: "Series:"
# thay "Loat truyen:", thieu "chua KIP noi loi tam biet"). Mr.Long cho phep 11/7 sua intro dat
# chuan R40 (khop ban ep_11+, khong sang tao moi) -> da fix intro + them disclaimer -> pass gate.
MEDIUM_HIGH_EPS = [
    # 9 medium ep_02-10 (intro fix R40 + disclaimer, per Mr.Long 11/7):
...
assert len(MEDIUM_HIGH_EPS) == 25, f"phai du 25 tap, dang co {len(MEDIUM_HIGH_EPS)}"

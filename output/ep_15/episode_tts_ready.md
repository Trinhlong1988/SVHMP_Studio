...
Tập 15, [pause:250ms] câu chuyện đêm nay.
...
Người đàn ông ngồi yên. Vuốt mặt gương, [pause:250ms] phía không sắc. Mảnh gương, [pause:250ms] phản chiếu trần xe loáng nhẹ, [pause:250ms] phản chiếu mặt anh, [pause:250ms] anh không nhìn vào mặt mình trong gương.

Khải Phong quan sát từ ghế ba. Mặt anh gầy. Hai mắt thâm, [pause:250ms] nhưng không buồn, [pause:250ms] bình tĩnh, [pause:250ms] như người đã quen sống với điều khó.
...
Anh ghế sáu vuốt vải bông quanh mép gương, [pause:250ms] kiểm tra mép có cứa được không. Mép kín, [pause:250ms] an toàn.
...
Xe đi qua một con phố xưa. Phía bên phải, [pause:250ms] một dãy phòng trọ tầng hai, [pause:250ms] đèn đỏ phòng cuối còn sáng. Cửa sổ phòng, [pause:250ms] bóng thanh niên đứng, [pause:250ms] tay cầm dao, [pause:250ms] cánh tay phải hắt máu. Không quay đầu.

Anh ghế sáu nhìn về phía đó. Mắt anh trống, [pause:250ms] vài giây, [pause:250ms] rồi anh thở ra.
...
[DIALOGUE_SEG_START]"Bố tôi thất vọng. Bố tôi muốn tôi vào Bách khoa, [pause:250ms] bố tôi đã đầu tư học thêm cho tôi từ cấp ba, [pause:250ms] học phí hai mươi triệu một năm, [pause:250ms] bố tôi không có nhiều tiền, [pause:250ms] bố làm thợ máy."[DIALOGUE_SEG_END]

[pause:800ms]

[DIALOGUE_SEG_START]"Khi tôi nhận giấy báo trượt, [pause:250ms] bố không nói gì sáu tháng. Bố không nhìn tôi. Bố ăn cơm cùng, [pause:250ms] nhưng không nói. Mẹ tôi đứng giữa, [pause:250ms] khóc."[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Tôi sống với cảm giác bố không thương, [pause:250ms] sáu tháng. Người con cũng học cao đẳng. Tôi không tự sát ngay, [pause:250ms] tôi cố."[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Năm tôi hai mốt, [pause:250ms] học năm cuối cao đẳng, [pause:250ms] bạn gái tôi chia tay. Cô bảo: 'Em không đợi anh được, [pause:250ms] anh chậm hai năm, [pause:250ms] em sắp tốt nghiệp đại học, [pause:250ms] em đi du học, [pause:250ms] anh không theo kịp.'"[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Tôi không khóc trước cô. Tôi về phòng trọ. Em ở ghép với hai bạn, [pause:250ms] hai bạn đi chơi đêm đó, [pause:250ms] phòng trống."[DIALOGUE_SEG_END]
...
[DIALOGUE_SEG_START]"Tôi đứng, [pause:250ms] máu chảy xuống sàn, [pause:250ms] vào áo. Tôi cảm thấy yếu, [pause:250ms] nằm xuống, [pause:250ms] chuẩn bị chết."[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Tôi quay đầu, [pause:250ms] nhìn mảnh gương vỡ to nhất còn trên sàn. Tôi thấy mặt mình trong gương tan, [pause:250ms] máu trên trán, [pause:250ms] mắt mờ."[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Tôi không nhận ra mình. Mặt trong gương, [pause:250ms] không phải Phong. Mặt người lạ, [pause:250ms] gầy hơn tôi, [pause:250ms] già hơn, [pause:250ms] buồn hơn."[DIALOGUE_SEG_END]
...
[DIALOGUE_SEG_START]"Tôi nằm viện ba ngày. Bố tôi đến. Bố không nói gì, [pause:250ms] bố ngồi bên giường tôi, [pause:250ms] vuốt tay tôi không bị cứa, [pause:250ms] vuốt liên tục, [pause:250ms] như xin lỗi không bằng lời."[DIALOGUE_SEG_END]

[pause:1500ms]

[DIALOGUE_SEG_START]"Mười năm tôi điều trị trầm cảm. Đi tâm lý mỗi tuần, [pause:250ms] uống thuốc, [pause:250ms] đỡ lấy, [pause:250ms] bệnh lại, [pause:250ms] đỡ lấy, [pause:250ms] bệnh lại. Vòng tròn."[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Tôi tốt nghiệp cao đẳng. Liên thông đại học. Ra trường lúc tôi hai mươi sáu. Đi làm thợ điện tự do, [pause:250ms] không vào công ty lớn, [pause:250ms] vì tôi sợ áp lực."[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Đời tôi không thành đạt như bố mẹ mong từ đầu. Tôi kiếm đủ ăn, [pause:250ms] sống thuê phòng nhỏ, [pause:250ms] không vợ, [pause:250ms] không con."[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Bố tôi mất năm tôi hai mươi bảy, [pause:250ms] đột quỵ. Bố không bao giờ nói rõ tha thứ, [pause:250ms] nhưng trước khi mất, [pause:250ms] bố ôm tôi. Tôi hiểu."[DIALOGUE_SEG_END]

[pause:1500ms]

[DIALOGUE_SEG_START]"Tôi giữ mảnh gương vỡ này mười năm. Chính mảnh tôi đập đêm hai mốt, [pause:250ms] sau đó tôi không vứt, [pause:250ms] tôi nhặt, [pause:250ms] cuốn vải mép sắc, [pause:250ms] giữ trong hộp."[DIALOGUE_SEG_END]
...
[DIALOGUE_SEG_START]"Đêm nay tôi đem mảnh gương về Hoài Đức, [pause:250ms] về hồ Đồng Mô, [pause:250ms] ném xuống nước. Kết thúc thời nhớ. Tôi giữ ký ức trong đầu, [pause:250ms] không cần vật ngoài. Bác sĩ tâm lý đã bảo: 'Khi em đủ vững, [pause:250ms] em sẽ tự buông được vật.'"[DIALOGUE_SEG_END]

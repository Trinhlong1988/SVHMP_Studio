# TẬP 33 — VÉ TÀU ĐIỆN HÀ NỘI NỘI THÀNH — TÔI HỨA ĐƯA BẠN ĐI
...
Tập 33, [pause:250ms] câu chuyện đêm nay.
...
Xe đi qua đó. Ga tàu khuất. Bóng cô gái đợi tàu khuất.

Cô gái ghế chín quay đầu. Vuốt vé tàu.
...
"Quỳnh và em quen từ năm hai đại học, [pause:250ms] cùng khoa văn, [pause:250ms] cùng lớp. Hai đứa em chơi thân, [pause:250ms] đi cà phê, [pause:250ms] đi xem phim, [pause:250ms] đi du lịch ngắn. Em ở Hà Nội, [pause:250ms] Quỳnh quê Thái Bình, [pause:250ms] em ở ký túc xá, [pause:250ms] em đến ở chơi nhà em mỗi cuối tuần.[DIALOGUE_SEG_START]"
...
[DIALOGUE_SEG_START]"Sáng hôm sau, [pause:250ms] em quá yếu, [pause:250ms] em không dậy. Em đưa em vào Bệnh viện K cấp cứu. Em mất chiều hôm đó, [pause:250ms] chính chiều em định đem em đi tàu điện."[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Vé tàu hai chiều em đặt ba năm, [pause:250ms] chưa dùng, [pause:250ms] em chưa kịp đi tàu trên cao Hà Nội, [pause:250ms] em không kịp giữ lời hứa với em."[DIALOGUE_SEG_END]

[pause:1500ms]

[DIALOGUE_SEG_START]"Em đem vé về Thái Bình, [pause:250ms] em đến tang em. Cô gái định đặt vé vào quan tài em. Em không đặt, [pause:250ms] em ngại, [pause:250ms] em không biết bạn có muốn vé này không."[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Em mang vé về Hà Nội. Ba năm em giữ vé trong ngăn kéo bàn. Em đi tàu điện một mình mỗi cuối tuần, [pause:250ms] không dùng vé Quỳnh, [pause:250ms] em không thể dùng vé em không nên dùng."[DIALOGUE_SEG_END]
...
[DIALOGUE_SEG_START]"Đêm nay, [pause:250ms] em đem vé về ga Cát Linh, [pause:250ms] chính ga em vừa bước lên xe. Em sẽ đặt vé vào hộp 'lost items' của ga, [pause:250ms] như cách trả vé cho người mất, [pause:250ms] em không phải người em. Em đi tàu một mình từ nay, [pause:250ms] không cần vé hai chiều."[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Em đi tàu một mình mỗi cuối tuần, [pause:250ms] em ngồi ghế bên cửa sổ, [pause:250ms] nhìn ra Hà Nội từ trên cao. Em nghĩ về em, [pause:250ms] em sống Hà Nội tám tháng cuối đời, [pause:250ms] em chưa kịp thấy thành phố từ trên cao một lần."[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Em đem theo vé Quỳnh ba năm trong ví, [pause:250ms] em không bao giờ dùng, [pause:250ms] em không thể dùng vé không nên dùng. Bây giờ em trả vé về ga, [pause:250ms] em đi tàu một mình thực sự, [pause:250ms] không mang theo Quỳnh trên đường."[DIALOGUE_SEG_END]

"Em định, [pause:250ms] sang năm em sẽ đem một bạn khác đi tàu điện. Cô gái quen một cô bạn mới ở văn phòng, [pause:250ms] cô ấy chưa đi tàu Cát Linh. Em sẽ rủ cô, [pause:250ms] em đặt vé hai chiều mới, [pause:250ms] em dùng. Như cách em làm tiếp điều em hứa Quỳnh, [pause:250ms] nhưng với người sống, [pause:250ms] không phải người đã đi.[DIALOGUE_SEG_START]"

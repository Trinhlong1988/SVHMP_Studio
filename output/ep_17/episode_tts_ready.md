...
Tập 17, [pause:250ms] câu chuyện đêm nay.
...
Người đàn ông đặt USB lên đùi. Hai tay anh đỡ lấy, [pause:250ms] như đỡ vật quý.
...
Xe đi qua xóm xưa. Phía bên trái, [pause:250ms] căn nhà tập thể, [pause:250ms] đèn phòng tầng hai còn sáng. Cửa sổ phòng, [pause:250ms] bóng người đàn ông trung niên ngồi trước bàn, [pause:250ms] tay cầm bút, [pause:250ms] viết. Không quay đầu.
...
[DIALOGUE_SEG_START]"Bạn thân nhất của tôi, [pause:250ms] Toàn, [pause:250ms] mất ba năm trước. Bốn mươi tuổi. Ung thư gan giai đoạn cuối, [pause:250ms] phát hiện muộn, [pause:250ms] sống thêm tám tháng."[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Tôi và Toàn quen từ tiểu học. Cùng làng. Cùng lớp cấp một. Cùng lớp cấp hai. Cấp ba tách trường, [pause:250ms] vẫn ở chung phòng học thêm. Đại học tách Hà Nội, [pause:250ms] Toàn bách khoa, [pause:250ms] tôi kinh tế. Tốt nghiệp, [pause:250ms] vẫn gặp nhau mỗi tuần."[DIALOGUE_SEG_END]

[pause:800ms]

[DIALOGUE_SEG_START]"Toàn cưới sớm, [pause:250ms] hai mươi sáu, [pause:250ms] vợ là bạn cùng lớp đại học. Sinh hai con. Sống Hà Đông, [pause:250ms] căn hộ chung cư nhỏ."[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Tôi cưới muộn, [pause:250ms] ba mươi mốt, [pause:250ms] sinh một con. Sống Đống Đa."[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Hai vợ chồng vẫn ăn cơm với nhau cuối tuần. Bạn từ tiểu học, [pause:250ms] không thay đổi."[DIALOGUE_SEG_END]

[pause:1200ms]

[DIALOGUE_SEG_START]"Bốn năm trước, [pause:250ms] Toàn đau bụng nhiều tháng. Đi khám, [pause:250ms] viêm gan. Điều trị. Sáu tháng sau, [pause:250ms] phát hiện ung thư. Giai đoạn cuối, [pause:250ms] đã di căn."[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Bác sĩ bảo: 'Cần thuốc nhập ngoại, [pause:250ms] hai trăm triệu một liệu trình, [pause:250ms] bảo hiểm không chi trả.'"[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Toàn không có hai trăm triệu. Lương kỹ sư Toàn nuôi gia đình, [pause:250ms] tiết kiệm được bốn năm chục triệu. Vợ Toàn nghỉ làm chăm con nhỏ."[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Toàn gọi tôi. Một tối, [pause:250ms] bảy giờ, [pause:250ms] tháng năm. Tôi đang họp công ty. Tôi không nghe. Cuộc gọi không nhận được."[DIALOGUE_SEG_END]

[pause:1500ms]

[DIALOGUE_SEG_START]"Tám giờ Toàn gọi lại. Tôi vẫn đang họp, [pause:250ms] quan trọng, [pause:250ms] đối tác Nhật. Tôi không bắt."[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Mười giờ tôi xong họp. Tôi gọi lại Toàn. Toàn không bắt. Tôi nghĩ: 'Toàn đang ngủ, [pause:250ms] sáng mai gọi.'"[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Sáng hôm sau, [pause:250ms] sáu giờ, [pause:250ms] Toàn nhắn tin: 'Tài ơi tôi xin mượn anh hai trăm triệu chữa ung thư. Tôi sẽ trả dần năm năm. Cảm ơn anh trước.'"[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Tôi đọc tin. Người đàn ông sốc, [pause:250ms] tôi không biết Toàn đến giai đoạn nặng. Tôi không gọi lại ngay, [pause:250ms] tôi đến công ty, [pause:250ms] họp tiếp, [pause:250ms] đối tác Nhật chưa xong việc hôm qua."[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Trưa tôi gọi Toàn. Toàn bắt. Giọng yếu. 'Tài ơi cảm ơn anh đọc tin. Anh quyết được không?'"[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Tôi nói: 'Toàn ơi anh đợi tôi vài hôm, [pause:250ms] tôi đang khó, [pause:250ms] công ty tôi đang khủng hoảng dòng tiền, [pause:250ms] tôi sẽ xoay, [pause:250ms] đầu tuần sau anh nhé.'"[DIALOGUE_SEG_END]

[pause:1500ms]

[DIALOGUE_SEG_START]"Toàn im một lúc. Rồi nói: 'OK Tài. Cảm ơn anh.'"[DIALOGUE_SEG_END]
...
[DIALOGUE_SEG_START]"Sau tang Toàn, [pause:250ms] vợ Toàn đưa tôi USB này. Bảo: 'Anh Toàn viết thư cho anh tuần trước, [pause:250ms] bảo em đưa anh nếu anh ấy đi. Thư trong USB.'"[DIALOGUE_SEG_END]
...
[DIALOGUE_SEG_START]"Ba năm tôi giữ USB. Mỗi đêm tôi mở, [pause:250ms] đọc thư Toàn, [pause:250ms] một lần. Như cách Toàn còn nói với tôi."[DIALOGUE_SEG_END]
...
"[DIALOGUE_SEG_END]Đêm nay, [pause:250ms] tôi đem USB về Sóc Sơn, [pause:250ms] về bệnh viện nơi Toàn nằm tháng cuối, [pause:250ms] em chôn USB trong vườn cây sau bệnh viện. Toàn không cần USB, [pause:250ms] Toàn đã đi, [pause:250ms] nhưng tôi cần buông. Tôi đã thuộc thư Toàn, [pause:250ms] không cần USB nữa.[DIALOGUE_SEG_START]"

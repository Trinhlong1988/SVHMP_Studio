...
Trời mưa rải nhẹ nhàng. Mặt đường ướt, [pause:250ms] gió biển thổi lên cửa kính xe.
...
Người đàn ông ngồi yên. Vuốt nơ đỏ trên hộp quà. Đầu ngón tay anh nhẹ, [pause:250ms] như sợ làm hư nơ.

Khải Phong quan sát từ ghế ba. Anh ba lăm, [pause:250ms] mặt sáng, [pause:250ms] vẻ người ổn, [pause:250ms] không khổ tâm, [pause:250ms] chỉ buồn nhẹ nhàng.
...
[DIALOGUE_SEG_START]"Tôi quý Lan, [pause:250ms] không yêu, [pause:250ms] chỉ quý. Hai đứa thân, [pause:250ms] đi học cùng, [pause:250ms] về cùng, [pause:250ms] cuối tuần đi cà phê vỉa hè cùng. Cả lớp gọi hai đứa em 'cặp bạn thân nhất.'"[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Cuối năm lớp mười, [pause:250ms] Lan ốm. Bố mẹ em đưa mẹ đi khám, [pause:250ms] phát hiện bạch cầu lympho cấp tính giai đoạn ba. Bác sĩ bảo: 'Cô sống thêm sáu tháng đến hai năm, [pause:250ms] chữa tốt sống được lâu hơn.'"[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Lan nghỉ học một học kỳ, [pause:250ms] vào Bệnh viện Huyết học Hà Nội điều trị. Em điều trị tám tháng, [pause:250ms] về quê Hạ Long, [pause:250ms] đỡ một phần, [pause:250ms] em quay lại học lớp mười một."[DIALOGUE_SEG_END]

[pause:1200ms]

[DIALOGUE_SEG_START]"Em yếu hơn trước, [pause:250ms] em không chạy được, [pause:250ms] em ăn ít, [pause:250ms] em hay mệt giữa giờ học. Em vẫn học giỏi, [pause:250ms] vẫn viết thơ."[DIALOGUE_SEG_END]
...
[DIALOGUE_SEG_START]"Tôi nghĩ về hộp quà em hai tháng. Người đàn ông quyết, [pause:250ms] tôi sẽ tặng em một hộp gỗ nhỏ, [pause:250ms] chứa bộ bút máy đẹp, [pause:250ms] bút em có thể viết thơ. Tôi đặt mua bút ở phố Tràng Tiền Hà Nội, [pause:250ms] gửi về Hạ Long."[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Tôi gói hộp quà, [pause:250ms] giấy quà xanh nhạt, [pause:250ms] nơ đỏ, [pause:250ms] em thích màu đỏ. Tôi chuẩn bị từ sinh nhật em mười bảy, [pause:250ms] định tặng em một năm sau."[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Tháng năm năm sau, [pause:250ms] em vào kỳ điều trị lại, [pause:250ms] bệnh nặng hơn. Em vào Bệnh viện Huyết học Hà Nội, [pause:250ms] không quay về."[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Em mất tháng tám, [pause:250ms] một tháng trước sinh nhật mười tám tuổi tháng chín. Tôi không kịp tặng em hộp quà."[DIALOGUE_SEG_END]

[pause:1500ms]

[DIALOGUE_SEG_START]"Tang em, [pause:250ms] tôi đến, [pause:250ms] tôi quỳ bên quan tài em. Em cầm hộp quà, [pause:250ms] định đặt vào quan tài em. Em không đặt, [pause:250ms] em nghĩ em đã chuẩn bị cho sinh nhật mười tám, [pause:250ms] em không thể đem em đi sinh nhật chưa xảy ra."[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Em cất hộp về nhà, [pause:250ms] đặt trong tủ, [pause:250ms] mười bảy năm. Không mở, [pause:250ms] không tặng ai khác, [pause:250ms] không vứt."[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Tôi sống tiếp. Người đàn ông học cấp ba xong, [pause:250ms] vào Đại học Du lịch, [pause:250ms] ra trường làm hướng dẫn viên ở Hạ Long. Tôi cưới vợ ba năm trước, [pause:250ms] vợ tôi biết chuyện hộp quà, [pause:250ms] em hiểu, [pause:250ms] không trách em giữ lại."[DIALOGUE_SEG_END]
...
"[DIALOGUE_SEG_END]Đêm nay, [pause:250ms] em gửi hộp qua bưu điện. Hộp sẽ đến bố mẹ em sáng mai. Em sẽ nhẹ lòng, [pause:250ms] không còn hộp trong tủ, [pause:250ms] không còn hứa chưa giữ lại.[DIALOGUE_SEG_START]"
...
Hai vợ chồng tương lai đã định, [pause:250ms] cưới đơn giản, [pause:250ms] sau cưới đem bố mẹ hai bên lên ăn cơm chung. Khải Phong không tổ chức cưới sau, [pause:250ms] Hạ Vy mất, [pause:250ms] không có ai để cưới.

# TẬP 34 — HƯƠNG TRẦM TÔI KHÔNG THẮP CHO HÀNG XÓM MƯỜI NĂM
...
Người đàn ông ngồi yên. Vuốt bó hương trầm, [pause:250ms] cẩn thận, [pause:250ms] không gãy chân hương.
...
Xe đi qua xóm xưa. Phía bên trái, [pause:250ms] căn nhà mái ngói, [pause:250ms] cửa khép. Đèn nến trong nhà còn cháy.

Cạnh cửa, [pause:250ms] bóng ông cụ chừng bảy mươi tuổi, [pause:250ms] áo sơ mi nâu xưa, [pause:250ms] đứng trên thềm, [pause:250ms] không quay đầu. Tay ông cầm cuốn sổ, [pause:250ms] như đang viết sổ ghi nhật ký.
...
[DIALOGUE_SEG_START]"Bác Bính là hàng xóm bên cạnh nhà tôi từ khi tôi sinh ra. Bác không vợ, [pause:250ms] không con, [pause:250ms] sống một mình căn nhà mái ngói nhỏ. Bác làm thư ký xã từ thời chiến tranh, [pause:250ms] về hưu năm sáu mươi, [pause:250ms] sống bằng lương hưu nhỏ."[DIALOGUE_SEG_END]

[pause:800ms]

[DIALOGUE_SEG_START]"Bác Bính thương tôi như cháu ruột. Năm tôi mười tuổi bố tôi mất, [pause:250ms] mẹ tôi đi làm xa, [pause:250ms] tôi ở nhà với ông bà nội. Bác Bính sang chơi mỗi tối, [pause:250ms] đem trái cây, [pause:250ms] kể chuyện ngày xưa, [pause:250ms] bác dạy tôi đọc thơ."[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Tôi lớn, [pause:250ms] đi học cấp ba huyện, [pause:250ms] tôi vẫn về cuối tuần, [pause:250ms] vẫn sang nhà bác. Bác làm tủ sách nhỏ, [pause:250ms] sách bác đọc cả đời, [pause:250ms] bác cho tôi mượn."[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Tôi đi đại học Hà Nội, [pause:250ms] tôi về thưa hơn, [pause:250ms] nhưng vẫn về Tết, [pause:250ms] vẫn ghé bác."[DIALOGUE_SEG_END]

[pause:1200ms]

[DIALOGUE_SEG_START]"Bác về hưu, [pause:250ms] già nhanh. Năm tôi ba bảy, [pause:250ms] bác sáu mươi tám, [pause:250ms] bác yếu, [pause:250ms] đi lại chậm lại. Tôi về quê, [pause:250ms] tôi sang chơi, [pause:250ms] bác ngồi ghế gỗ mun, [pause:250ms] kể chuyện thường, [pause:250ms] không phàn nàn."[DIALOGUE_SEG_END]

"Năm tôi bốn mươi, [pause:250ms] bác bảy mốt, [pause:250ms] bác mất. Đêm, [pause:250ms] bác đi ngủ, [pause:250ms] sáng hàng xóm khác sang tìm bác, [pause:250ms] không thấy bác dậy. Cửa nhà khép, [pause:250ms] không khóa. Hàng xóm vào, [pause:250ms] thấy bác nằm trên giường, [pause:250ms] đã đi rất xa."

[DIALOGUE_SEG_START]"Tôi đang ở Hà Nội, [pause:250ms] bận họp xã đó, [pause:250ms] không về kịp tang bác. Đám tang xã làng tổ chức, [pause:250ms] vài người hàng xóm, [pause:250ms] không gia đình."[DIALOGUE_SEG_END]

[pause:1500ms]

[DIALOGUE_SEG_START]"Tôi về quê hai ngày sau tang. Bác đã chôn ở nghĩa trang xã đó. Tôi đến mộ, [pause:250ms] quỳ, [pause:250ms] thắp hương, [pause:250ms] xin lỗi không về kịp."[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Tôi định: mỗi rằm tháng bảy, [pause:250ms] tôi sẽ thắp hương cho bác. Tôi không có gia đình bác, [pause:250ms] tôi là người duy nhất còn nhớ bác, [pause:250ms] tôi thay con cháu thắp hương."[DIALOGUE_SEG_END]

"Năm đầu, [pause:250ms] tôi thắp hương rằm tháng bảy, [pause:250ms] đem hoa cúc, [pause:250ms] thắp nến. Năm thứ hai, [pause:250ms] tôi cũng thắp. Năm thứ ba, [pause:250ms] tôi bận họp xã đó, [pause:250ms] quên, [pause:250ms] đến cuối tháng tám tôi nhớ, [pause:250ms] tôi không đi vì đã muộn, [pause:250ms] tôi định năm sau bù.[DIALOGUE_SEG_START]"

[pause:1500ms]

"[DIALOGUE_SEG_END]Năm sau, [pause:250ms] rằm tháng bảy, [pause:250ms] tôi cũng quên. Đến năm thứ năm, [pause:250ms] tôi quên hoàn toàn, [pause:250ms] không nhớ đã quên. Năm thứ sáu, [pause:250ms] bảy, [pause:250ms] tám, [pause:250ms] chín, [pause:250ms] mười, [pause:250ms] không lần nào tôi thắp."

[DIALOGUE_SEG_START]"Mười năm tôi không thắp hương cho bác Bính. Tôi không phải bận, [pause:250ms] tôi quên. Tôi chỉ nhớ khi nhìn ngôi nhà mái ngói bác bên cạnh, [pause:250ms] đã bán cho người khác, [pause:250ms] đã xây lại cấp bốn, [pause:250ms] không giống nhà bác."[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Năm vừa rồi, [pause:250ms] tôi năm chục, [pause:250ms] sắp tròn mười năm bác đi. Tôi quyết, [pause:250ms] tôi sẽ bù mười năm tôi quên."[DIALOGUE_SEG_END]

[pause:1500ms]

[DIALOGUE_SEG_START]"Tôi mua bó hương trầm này, [pause:250ms] bó dài, [pause:250ms] bó đặt làm riêng, [pause:250ms] tôi định đốt toàn bộ bó tại mộ bác. Mười năm tôi không thắp, [pause:250ms] đêm nay tôi thắp một lần, [pause:250ms] đủ mười năm."[DIALOGUE_SEG_END]
...
[DIALOGUE_SEG_START]"Tôi không nói với vợ tôi về việc tôi quên thắp hương mười năm. Tôi xấu hổ, [pause:250ms] tôi sợ vợ trách. Vợ tôi tốt, [pause:250ms] không trách, [pause:250ms] nhưng tôi xấu hổ với chính tôi, [pause:250ms] không phải với vợ."[DIALOGUE_SEG_END]
...
Cố nhớ. Năm đầu sau Hạ Vy mất, [pause:250ms] 2018, [pause:250ms] Khải Phong về Hải Phòng tháng tư, [pause:250ms] rằm tháng tám, [pause:250ms] Tết. Ba lần một năm. Khải Phong thắp hương đều.

Năm hai, [pause:250ms] 2019, [pause:250ms] Khải Phong về hai lần. Tháng tư + Tết. Khải Phong bận công việc, [pause:250ms] không về rằm tháng tám.

Năm ba, [pause:250ms] 2020, [pause:250ms] Covid. Khải Phong không về quê. Chỉ thắp hương trong căn phòng trọ Hà Nội, [pause:250ms] đặt ảnh Hạ Vy trên bàn, [pause:250ms] thắp ba nén.

Năm bốn, [pause:250ms] 2021, [pause:250ms] Khải Phong về một lần Tết. Tháng tư rằm tháng tám không về.

[pause:1500ms]

Năm năm, [pause:250ms] 2022, [pause:250ms] Khải Phong cũng chỉ về Tết.

Năm sáu, [pause:250ms] 2023, [pause:250ms] Khải Phong về Tết.

Năm bảy, [pause:250ms] 2024, [pause:250ms] Khải Phong về Tết.

Năm tám, [pause:250ms] 2025, [pause:250ms] đây là năm hiện tại, [pause:250ms] Khải Phong đã về Tết tháng giêng, [pause:250ms] tháng tư chưa về.

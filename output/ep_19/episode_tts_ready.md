...
Tập 19, [pause:250ms] câu chuyện đêm nay.
...
[DIALOGUE_SEG_START]"Bạn em, [pause:250ms] Mai, [pause:250ms] mất một tháng trước. Bốn mươi tám tuổi. Ung thư vú giai đoạn cuối, [pause:250ms] chữa hai năm, [pause:250ms] không qua ở đó."[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Em và Mai bạn từ cấp hai, [pause:250ms] cùng lớp. Cùng xã Đông Hội. Cấp ba cùng trường. Đại học tách Hà Nội, [pause:250ms] em ngoại lời, [pause:250ms] Mai sư phạm. Tốt nghiệp, [pause:250ms] Mai về quê dạy cấp hai. Em ở Hà Nội, [pause:250ms] sau hai mươi năm về quê, [pause:250ms] làm cán bộ xã đó."[DIALOGUE_SEG_END]

[pause:800ms]

[DIALOGUE_SEG_START]"Hai mươi năm em xa quê, [pause:250ms] em ít gặp Mai. Mỗi Tết em về, [pause:250ms] gặp Mai ở chợ, [pause:250ms] vài lời chào. Mai không trách em xa lạ, [pause:250ms] Mai vẫn coi em bạn."[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Em về quê làm cán bộ, [pause:250ms] sáu năm trước, [pause:250ms] gặp Mai thường. Hai bạn nói chuyện hồi cấp ba, [pause:250ms] hồi tuổi trẻ, [pause:250ms] cười."[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Mai chưa lấy chồng. Sống một mình, [pause:250ms] căn nhà mái ngói nhỏ ở xã đó. Mẹ Mai mất sớm, [pause:250ms] bố Mai mất sau đó, [pause:250ms] Mai một mình từ ba mươi."[DIALOGUE_SEG_END]

[pause:1200ms]

[DIALOGUE_SEG_START]"Hai năm trước, [pause:250ms] Mai phát hiện ung thư vú. Phẫu thuật, [pause:250ms] hóa trị, [pause:250ms] đỡ lấy, [pause:250ms] bệnh lại. Mai gầy. Mai cô đơn, [pause:250ms] không có ai chăm, [pause:250ms] em đến giúp vài lần, [pause:250ms] nấu cơm, [pause:250ms] đem thuốc."[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Tháng cuối, [pause:250ms] Mai nặng. Mai gọi em: 'Hoa ơi em đến đây đi, [pause:250ms] em ngủ một đêm với chị, [pause:250ms] chị sợ một mình.'"[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Em đáp: 'Mai ơi tuần này em bận họp xã đó, [pause:250ms] cuối tuần em đến.'"[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Mai nói: 'OK Hoa.'"[DIALOGUE_SEG_END]

[pause:1500ms]

[DIALOGUE_SEG_START]"Em bận thật. Họp xã đó, [pause:250ms] duyệt báo cáo, [pause:250ms] em không đến cuối tuần. Em định: 'Tuần sau.'"[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Tuần sau, [pause:250ms] em nhận điện thoại hàng xóm Mai. Bác hàng xóm khóc: 'Hoa ơi Mai đi sáng nay, [pause:250ms] bác thấy không có ai đến đêm qua, [pause:250ms] Mai đi một mình.'"[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Em chạy đến nhà Mai. Mai nằm trên giường, [pause:250ms] gầy, [pause:250ms] mặt yên, [pause:250ms] đã đi sáng sớm, [pause:250ms] không có ai bên cạnh."[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Em quỳ bên Mai. Cô gái xin lỗi, [pause:250ms] qua thân xác đã đi. Em không đến tuần trước, [pause:250ms] Mai đi một mình, [pause:250ms] em không có mặt."[DIALOGUE_SEG_END]
...
[DIALOGUE_SEG_START]"Em sốc. Cô gái không hề trả lời. Em ngồi xuống bên quan tài Mai. Quỳ cả đêm."[DIALOGUE_SEG_END]

[pause:1500ms]

[DIALOGUE_SEG_START]"Sau tang, [pause:250ms] em sửa lại. Em không thể đem Mai sống lại. Nhưng em có thể đem cúc, [pause:250ms] Mai thích cúc, [pause:250ms] hồi cấp hai Mai hay cài cúc tóc."[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Mỗi tháng em đem vòng hoa cúc đến mộ Mai. Em đặt cúc, [pause:250ms] em quỳ, [pause:250ms] em xin lỗi từng tháng."[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Hôm nay, [pause:250ms] đúng tháng thứ nhất Mai đi. Em đem vòng cúc lớn, [pause:250ms] đẹp, [pause:250ms] em chọn ở chợ Đông Anh, [pause:250ms] sáng nay, [pause:250ms] cúc tươi nhất."[DIALOGUE_SEG_END]
...
"Đêm nay, [pause:250ms] em đem vòng cúc lớn, [pause:250ms] đặt lên mộ Mai. Quỳ. Nói: 'Mai ơi tháng đầu chị đi. Hoa đến mỗi tháng, [pause:250ms] không lỡ nữa thôi. Cúc tươi, [pause:250ms] chị nhớ chị cài cúc tóc cấp hai không, [pause:250ms] Hoa nhớ, [pause:250ms] Hoa đem cúc cho chị, [pause:250ms] đến lúc Hoa không đi nổi nữa.'[DIALOGUE_SEG_START]"

...
Tập 37, [pause:250ms] câu chuyện đêm nay.
...
Cô vuốt mảnh biển, [pause:250ms] không khóc, [pause:250ms] chỉ vuốt.
...
[DIALOGUE_SEG_START]"Em và Hùng cưới ba năm, [pause:250ms] chưa có con. Hai vợ chồng còn trẻ, [pause:250ms] định có con sau khi mua được nhà nhỏ ở Hà Nội."[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Hùng làm kỹ sư phần mềm, [pause:250ms] công ty Việt Nhật ở Cầu Giấy. Em làm giáo viên, [pause:250ms] trường ở Bạch Mai. Hai đứa em đi làm sáng cùng, [pause:250ms] đi về tối cùng, [pause:250ms] chở nhau bằng xe máy."[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Đêm mất em, [pause:250ms] Hùng đi học thêm khóa kỹ thuật tối, [pause:250ms] sáu tháng nay. Em về phòng trọ một mình tối thứ ba và thứ năm. Đêm thứ ba mất em, [pause:250ms] em học thêm xong mười giờ tối, [pause:250ms] đi xe máy về phòng trọ, [pause:250ms] đoạn phố Huế, [pause:250ms] em va chạm."[DIALOGUE_SEG_END]

[pause:1200ms]

[DIALOGUE_SEG_START]"Em chạy đến bệnh viện đêm đó. Em đã đưa vào phòng cấp cứu, [pause:250ms] em mất ba mươi phút sau khi vào viện, [pause:250ms] chấn thương sọ não nặng."[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Em quỳ bên giường em trong phòng tang. Em không khóc, [pause:250ms] em sốc, [pause:250ms] em không thể tin chỉ vài giờ trước em còn ăn cơm chung em ở phòng trọ."[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Tang em, [pause:250ms] gia đình em, [pause:250ms] mẹ em từ Bình Định ra Hà Nội, [pause:250ms] bố em đã mất sớm. Mẹ em ôm bạn, [pause:250ms] khóc, [pause:250ms] bảo: 'Con ơi mẹ biết em là con trai mẹ, [pause:250ms] em đã chọn em, [pause:250ms] bây giờ em đi, [pause:250ms] em sống tiếp.'"[DIALOGUE_SEG_END]
...
[DIALOGUE_SEG_START]"Một năm em giữ mảnh biển số. Em không treo, [pause:250ms] em cất trong ngăn kéo bàn. Em không nhìn, [pause:250ms] em chỉ biết nó ở đó."[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Năm vừa rồi, [pause:250ms] em quyết. Em sẽ trả mảnh biển về tiệm sửa xe, [pause:250ms] chính tiệm Toàn đã giữ trước đây. Để mảnh ở nơi nó từng ở, [pause:250ms] không ở chỗ em, [pause:250ms] em đã đủ ký ức."[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Em cũng quyết, [pause:250ms] em sẽ chuyển nhà. Cô gái bán phòng trọ, [pause:250ms] em chuyển sang căn hộ chung cư nhỏ ở phố Cầu Giấy, [pause:250ms] gần nơi làm chồng em làm xưa. Em sống tiếp."[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Em không tái hôn ngay. Cô gái ba lăm hai, [pause:250ms] em còn thời gian. Em đợi em hồi phục, [pause:250ms] em đợi mẹ em yên tâm, [pause:250ms] em đợi chính em quyết."[DIALOGUE_SEG_END]
...
[DIALOGUE_SEG_START]"Đêm nay, [pause:250ms] em đem mảnh biển số về tiệm Sửa xe Toàn, [pause:250ms] chính tiệm em vừa bước lên xe. Em sẽ gửi mảnh cho anh Toàn, [pause:250ms] anh giữ tiếp. Em đã đủ, [pause:250ms] em không cần vật chứng nữa."[DIALOGUE_SEG_END]

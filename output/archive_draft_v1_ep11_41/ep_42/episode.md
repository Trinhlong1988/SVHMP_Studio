# TẬP 42 — MỘT VẬT CŨ, CHƯA KỊP XIN LỖI

```
prompt_version: SVHMP-10.0-RC3.4
ep_number: 42
phase: mid (42/90)
passenger_main: PAS_0053 (Hợp Ái, nu 18-25)
regret_pillar: love_regret
regret_sub: REG_LOV_003
signature_object: OBJ_NHAN_CUOI
signature_setting: setting_TBD
stop_location: ngã ba Đắk Nông
bell_count: 1
ghost_manifest: 1
...
Đêm hai tám tháng Chạp. Mưa phùn lất phất. Chuyến xe đêm chạy qua một đoạn đường vắng ven Nông. Bụi mía sương mờ ven đường vắng. Đèn pha quét nhẹ lên hai bên đường tối.

Quang ngồi ghế thứ ba. Đêm thứ 42 Quang đếm. Trong túi áo Quang đã có 40 vật — các vật rời rạc từ những đêm trước. Sợi len. Sợi lạt. Phong bao trống. Sợi chỉ trắng. Viên pin cassette. Mỗi vật một câu chuyện. Quang chưa hiểu vì sao mình giữ.
...
Cô gái trẻ. Khoảng 18-25 tuổi. Mặc áo đơn giản, tay xách một túi vải nhỏ. Bên trong túi có một vật cũ — đã sờn. Cô đứng yên dưới mái hiên, hơi thở chậm trong sương lạnh.

Cô bước lên xe nhẹ. Đi nhẹ xuống lối giữa. Ngồi vào ghế thứ 8. Đặt một vật cũ lên đùi. Tay trái vẫn cầm vé xe đã nhàu.
...
Đồng hồ trên xe — chiếc đồng hồ nhỏ gắn cạnh ghế lái — kim phút nhích. Tách. Tách. Tách. Tách. Tách. Tách. Tách. Tách. Tách. 9 lần liền. Quang đếm. Đêm thứ 42, 9 lần.
...
"Cô tên Hợp Ái. 18-25. Năm nay cô ngồi đây — chỗ mẹ chồng cô ngày xưa ngồi."

Giọng cô chậm, không buồn.

"Mẹ chồng cô ngày cô mười tám tuổi đã dạy cô cách giữ vật này. Mẹ chồng bảo: 'Sau này con sẽ đợi. Hôm nay con học cách đợi.' Cô không tin."
...
"Đêm nay cô đem vật về đặt lên ban thờ mẹ chồng. Cảm ơn mẹ chồng đã dạy cô cách đợi không trách. Cảm ơn mẹ chồng đã không bỏ cô lại lúc cô bỏ mẹ chồng lại."
...
Trên ghế thứ 8 giờ đã trống. Đệm ghế còn lõm xuống một chút — như vừa có ai ngồi rất nhẹ. Trên sàn xe, có một mảnh vật nhỏ rơi xuống. Quang nhặt lên. Mảnh nhỏ của một vật cũ — cô vô tình đánh rơi khi đứng dậy.

Quang cất vào túi áo. Vật thứ 41.
...
Quang lấy 41 vật trong túi ra. Đặt cạnh nhau trên đùi. Một bộ sưu tập rời rạc — của những người đã chưa kịp nói câu cuối với người họ thương.

Quang nhớ — đêm thứ 42 Quang đã ngồi ghế thứ ba. Mỗi đêm một câu chuyện. Mỗi đêm Quang ngồi yên — chưa kể câu chuyện nào của mình.
...
Quang nhớ — câu hát ông cụ ghế đầu vẫn mở mỗi đêm: "...quê nhà...". Quang chưa hiểu câu hát đó. Nhưng đêm thứ 42 rồi, Quang vẫn nghe được.
...
- ALWAYS_5: melancholy / unresolved_goodbye / object_symbolism (OBJ_NHAN_CUOI) / subtle_supernatural (1 ghost manifest) / emotional_aftertaste
...
- bible/23: char_name "Hợp Ái" 2 âm tiết, không forbidden
- bible/12: signature_object OBJ_NHAN_CUOI trong library
- bible/13: signature_setting setting_TBD trong library
- bible/18: EP42 ≠ EP73/EP90 reserved
- Cross-ep continuity: Quang nhặt 40 vật + clock 7:10 + driver gradient

...
[DIALOGUE_SEG_START]"Tôi cưới Hồng năm tôi hai mươi ba, [pause:250ms] em hai mươi mốt. Hai đứa cùng làng. Đám cưới làng, [pause:250ms] đơn giản, [pause:250ms] nhẫn vàng nhỏ, [pause:250ms] em mua ở chợ huyện."[DIALOGUE_SEG_END]

[pause:800ms]

[DIALOGUE_SEG_START]"Cưới được ba năm, [pause:250ms] em sinh con đầu, [pause:250ms] bé gái, [pause:250ms] em đặt tên Hoa. Hoa khỏe, [pause:250ms] bụ bẫm, [pause:250ms] em thương mẹ."[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Em đi biển. Mỗi chuyến đi ba đến năm ngày. Em về, [pause:250ms] Hồng đón em ở bến, [pause:250ms] bế Hoa, [pause:250ms] cười. Cuộc sống bình thường."[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Năm Hoa ba tuổi, [pause:250ms] em đi chuyến biển dài, [pause:250ms] tám ngày, [pause:250ms] vào đợt cá nhiều. Em về sớm hai ngày, [pause:250ms] bão không vào kịp như dự báo."[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Em về bến, [pause:250ms] không thấy Hồng đón. Người đàn ông đi bộ về nhà. Em mở cửa, [pause:250ms] em thấy Hồng nằm trên giường, [pause:250ms] không một mình."[DIALOGUE_SEG_END]

[pause:1200ms]

[DIALOGUE_SEG_START]"Có một người đàn ông, [pause:250ms] bạn em cùng làng, [pause:250ms] anh Tâm, [pause:250ms] nằm cạnh Hồng. Hai người đang ngủ, [pause:250ms] không nghe em mở cửa."[DIALOGUE_SEG_END]

"Em đứng lặng yên. Người đàn ông không la, [pause:250ms] không đánh, [pause:250ms] không nói. Em đi ra ngoài, [pause:250ms] ngồi dưới gốc cau trước nhà, [pause:250ms] hai giờ. Hồng tỉnh dậy, [pause:250ms] phát hiện em đứng ngoài, [pause:250ms] em mặc quần áo, [pause:250ms] chạy ra ngoài. Anh Tâm cũng chạy ra, [pause:250ms] không nhìn em, [pause:250ms] đi về nhà anh."

[DIALOGUE_SEG_START]"Hồng quỳ trước em. Em không khóc, [pause:250ms] em không xin lỗi, [pause:250ms] em chỉ nói: 'Anh ơi em xin lỗi, [pause:250ms] anh muốn em làm gì.'"[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Em đáp: 'Ly hôn. Tôi nuôi Hoa. Em đi khỏi nhà, [pause:250ms] tôi không muốn thấy em nữa.'"[DIALOGUE_SEG_END]
...
[DIALOGUE_SEG_START]"Hồng không gặp Hoa nữa. Em đi khỏi làng sau ly hôn, [pause:250ms] em sang xã bên ở, [pause:250ms] em lấy chồng khác, [pause:250ms] anh Tâm, [pause:250ms] chính anh tôi bắt gặp. Họ cưới một năm sau ly hôn em. Họ sinh hai con khác."[DIALOGUE_SEG_END]

[pause:1500ms]

[DIALOGUE_SEG_START]"Ba mươi năm em không gặp Hồng. Em không nói chuyện với Hồng. Em không trao đổi gì."[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Em thấy em đôi khi ở chợ huyện, [pause:250ms] em mua bán, [pause:250ms] không nhìn nhau. Em tránh em, [pause:250ms] em tránh em."[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Năm vừa rồi, [pause:250ms] Hoa về quê thăm em. Hoa nói: 'Bố ơi con vừa nhận tin mẹ Hồng đang ung thư gan giai đoạn cuối. Bố ơi mẹ con, [pause:250ms] con muốn về thăm mẹ trước khi mẹ đi. Bố cho phép không?'"[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Em đã im lặng. Người đàn ông nghĩ thầm. Em nói: 'Hoa ơi con là con của mẹ, [pause:250ms] bố không cấm. Con về thăm mẹ con đi.'"[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Hoa về thăm Hồng tháng trước. Hồng nằm, [pause:250ms] gầy, [pause:250ms] yếu. Hồng nói với Hoa: 'Mẹ xin lỗi con ba mươi năm, [pause:250ms] mẹ bỏ con khi con ba tuổi, [pause:250ms] mẹ không có quyền làm mẹ. Con tha lỗi mẹ không?'"[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Hoa khóc bên giường. Bảo: 'Mẹ ơi con tha. Con không trách mẹ, [pause:250ms] bố con nuôi con tốt, [pause:250ms] con không thiếu, [pause:250ms] chỉ thiếu mẹ.'"[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Hồng nói: 'Mẹ xin con, [pause:250ms] về nói với bố con, [pause:250ms] mẹ xin lỗi anh ấy ba mươi năm. Mẹ đã sai. Mẹ không sống tiếp được, [pause:250ms] mẹ xin anh ấy tha mẹ, [pause:250ms] mẹ đi yên.'"[DIALOGUE_SEG_END]
...
[DIALOGUE_SEG_START]"Em đem nhẫn đến tang, [pause:250ms] em định đặt vào quan tài Hồng. Em không đặt, [pause:250ms] em ngại, [pause:250ms] đã ba mươi năm, [pause:250ms] em không có quyền."[DIALOGUE_SEG_END]

[DIALOGUE_SEG_START]"Em cầm về."[DIALOGUE_SEG_END]
...
"[DIALOGUE_SEG_END]Đêm nay, [pause:250ms] tôi quay lại nhà thờ Vĩnh Hòa, [pause:250ms] em đặt nhẫn cưới cũ trên bục giáo xứ, [pause:250ms] không phải mộ em, [pause:250ms] trên bục thờ Chúa. Vì em theo đạo Công giáo, [pause:250ms] em chôn theo nghi lễ hội. Em đặt nhẫn ở bục, [pause:250ms] nói với Chúa thay vì với em: 'Chúa ơi xin Chúa truyền lời em, [pause:250ms] em tha em ba mươi năm, [pause:250ms] em đi yên.'[DIALOGUE_SEG_START]"

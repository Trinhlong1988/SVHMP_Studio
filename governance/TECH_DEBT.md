...
- **Trạng thái:** MỞ — giao kèm `prompts/TASK_DEBT030_031_CONTENT_FIX.md` (Bước 3 của task đó), để CMD_BUILD/CMD_BUILD_2 xây enforcer NGAY sau khi sửa xong nội dung, tránh tái diễn cho tập tiếp theo.
...
- **Trạng thái:** MỞ — giao kèm `prompts/TASK_DEBT030_031_CONTENT_FIX.md` (Bước 4).
